...
rna<-fread("data_RNA_Seq_expression_tpm.txt")
...
colnames(total)[20880] <- "meta.Sample Identifier.1"
...
saveRDS(total, "mel_dfci_2019_TPM_all.rds")

nivo_data <- total[meta.ICB == "Nivolumab Therapy", ]

saveRDS(nivo_data, "mel_dfci_2019_TPM_nivo.rds")

pembro_data <- total[meta.ICB == "Pembrolizumab Therapy", ]

saveRDS(pembro_data, "mel_dfci_2019_TPM_pembro.rds")
...
saveRDS(nivo_data, "mel_dfci_2019_zTPM_nivo.rds")

pembro_data <- total[meta.ICB == "Pembrolizumab Therapy", ]

saveRDS(pembro_data, "mel_dfci_2019_zTPM_pembro.rds")


#################################################################################################################################################################
uploaded_data <- readRDS("C:/Users/memre/OneDrive - Izmir Yuksek Teknoloji Enstitusu/IYTE/PhD/R/CbioPortal/mel_dfci_2019/mel_dfci_2019_TPM_all.rds")
...
saveRDS(nivo_data, "mel_dfci_2019_TPM_LOG_meta_LOG_nivo.rds")

pembro_data <- total[meta.ICB == "Pembrolizumab Therapy", ]

saveRDS(pembro_data, "mel_dfci_2019_TPM_LOG_meta_LOG_pembro.rds")
#################################################################################################################################################################
...
mel_dfci_2019_TPM_LOG_meta_LOG_all$meta.project_id<-mel_dfci_2019_TPM_LOG_meta_LOG_all$meta.Cancer.Type.Detailed

mel_dfci_2019_TPM_LOG_meta_LOG_all$meta.definition<-mel_dfci_2019_TPM_LOG_meta_LOG_all$meta.Biopsy.Context

# mel_dfci_2019_TPM_LOG_meta_LOG_all$meta.age_at_diagnosis<-mel_dfci_2019_TPM_LOG_meta_LOG_all$meta.Age.at.Diagnosis
# 
# mel_dfci_2019_TPM_LOG_meta_LOG_all$meta.Age.at.Diagnosis<-NULL

saveRDS(mel_dfci_2019_TPM_LOG_meta_LOG_all,"mel_dfci_2019_tcgex.rds")
