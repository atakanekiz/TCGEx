      ...
      if(input$gsea_gene_sets == 'Custom Gene Set') {
        ...
        data.frame(
          ...
          intro = paste(c(
            ...
            "You can decide the width (px) of the plot to download. You can download the plot directly by click on the download button without click on the analyze button. ",
            "You can decide the height(px) of the plot to download. You can download the plot directly by click on the download button without click on the analyze button ."
          ))
